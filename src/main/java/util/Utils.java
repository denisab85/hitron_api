...
public class Utils {
	...
	private static final String URI_MAP_FILE_NAME = "URI";

	private static Logger log = Logger.getLogger(Utils.class.getName());
	private static ResourceBundle prop = ResourceBundle.getBundle(PROPERTIES_FILE_NAME);
	private static ResourceBundle uri = ResourceBundle.getBundle(URI_MAP_FILE_NAME);
	...
	public static String getUri(String property) {
		log.debug(String.format("Reading '%s' from URI map file", property));
		return uri.getString(property);
	}
